...
PM_START_TEXT = """
`Hellow` [🤗](https://telegra.ph/file/78f80ffb9c88c5a0eedb8.jpg) `My name is` *Miss Shasa*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Add Miss Shasa To Your Group ➕️", url="t.me/MissShasa_bot?startgroup=true"),
    ],
    [
...
HELP_STRINGS = """
`Hi.. I'm` [Miss Shasa🙋‍♀️](https://telegra.ph/file/78f80ffb9c88c5a0eedb8.jpg)
`Click on the buttons below to get documentation about specific modules..`"""


yone_IMG = "https://telegra.ph/file/78f80ffb9c88c5a0eedb8.jpg"
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Miss Shasa*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Repository](https://github.com/Mdnoor786/MissShasa_bot).
                 \n\nIf you have any question about MissShasa, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Miss Shasa*
                 \nHere is the [Source Code](https://github.com/MdNoor786/MissShasa_bot) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
